...
private boolean reserveTicket(String trainName, String trainNumber, String date, String time, String source, String destination)
{
  try {
  // Execute a SQL query to insert reservation details into the database
  Random rn = new Random();
  int pnr = rn.nextInt(100000000,999999999);
